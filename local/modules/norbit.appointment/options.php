...
$aTabs = array(
    array(
        ...
        "OPTIONS" => array(
            ...
            array(
                // имя элемента формы, для хранения в бд
                "norbitappointmen_multiselectbox",
                // поясняющий текст
    ...
    foreach ($aTabs as $aTab) {
        ...
        foreach ($aTab["OPTIONS"] as $arOption) {
            ...
            if ($request["Update"]) {
                ...
                if ($arOption[0] == "norbitappointmen_checkbox") {
                    if ($optionValue == "") {
                        $optionValue = "N";
                    }
                }
...
// $op = \Bitrix\Main\Config\Option::getForModule("norbit.appointment");
